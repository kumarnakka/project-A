...
namespace adas_dds {
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    ImagePluginSupport_create_data_w_params(
    ...
    ImagePluginSupport_destroy_data_w_params(
        Image *sample,
    ...
    * ------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern RTIBool
    ImagePlugin_serialize_to_cdr_buffer(
        char * buffer,
        unsigned int * length,
        const Image *sample); 

    NDDSUSERDllExport extern RTIBool
    ImagePlugin_serialize_to_cdr_buffer_ex(
        char *buffer,
        unsigned int *length,
        const Image *sample,
    ...
    NDDSUSERDllExport extern RTIBool
    ImagePlugin_deserialize_from_cdr_buffer(
        Image *sample,
        const char * buffer,
        unsigned int length);    
    #ifndef NDDS_STANDALONE_TYPE
    NDDSUSERDllExport extern DDS_ReturnCode_t
    ImagePlugin_data_to_string(
        const Image *sample,
        char *str,
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    NDDSUSERDllExport extern unsigned int 
    ImagePlugin_get_serialized_key_max_size_for_keyhash(
        PRESTypePluginEndpointData endpoint_data,
        RTIEncapsulationId encapsulation_id,
        unsigned int current_alignment);
    ...
    struct RTIXCdrInterpreterPrograms *ImagePlugin_get_programs();
