...
namespace adas_dds {
    ...
    */
    ...
    DDS_TYPESUPPORT_CPP(
        PointXYZRTHITypeSupport, 
        PointXYZRTHI);

    #define ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(PointXYZRTHIDataWriter, PointXYZRTHI);
    #undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    #define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
    DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(PointXYZRTHIDataReader, PointXYZRTHISeq, PointXYZRTHI);
