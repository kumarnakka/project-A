...
namespace adas_dds {
    namespace dbw_mkz_msgs {
        ...
        */
        ...
        NDDSUSERDllExport RTIXCdrSampleAccessInfo *BrakeCmd_PedalCmdType_get_sample_seq_access_info(void);
        #endif

        DDS_SEQUENCE(BrakeCmd_PedalCmdTypeSeq, BrakeCmd_PedalCmdType);
        ...
        RTIBool BrakeCmd_PedalCmdType_initialize_ex(
            BrakeCmd_PedalCmdType* self,RTIBool allocatePointers,RTIBool allocateMemory);
        ...
        NDDSUSERDllExport
        void BrakeCmd_PedalCmdType_finalize(
            BrakeCmd_PedalCmdType* self);
        ...
        */
        ...
        NDDSUSERDllExport RTIXCdrSampleAccessInfo *BrakeCmd_get_sample_seq_access_info(void);
        #endif

        DDS_SEQUENCE(BrakeCmdSeq, BrakeCmd);
        ...
        RTIBool BrakeCmd_initialize_ex(
            BrakeCmd* self,RTIBool allocatePointers,RTIBool allocateMemory);
...
namespace rti { 
    namespace xcdr {
        template <>
        struct type_code<adas_dds::dbw_mkz_msgs::BrakeCmd> {
