...
namespace adas_dds {
    ...
    */
    ...
    DDS_TYPESUPPORT_CPP(
        LineHeaderTypeSupport, 
        LineHeader);

    #define ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(LineHeaderDataWriter, LineHeader);
    #undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    #define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
    DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(LineHeaderDataReader, LineHeaderSeq, LineHeader);
