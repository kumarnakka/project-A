...
#endif
#include "ndds/ndds_flat_data_cpp.h"
...
namespace common {
    ...
    */
    ...
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *Format_get_sample_seq_access_info(void);
    #endif

    DDS_SEQUENCE(FormatSeq, Format);
    ...
    RTIBool Format_initialize_ex(
        Format* self,RTIBool allocatePointers,RTIBool allocateMemory);
...
namespace common_flat {
    ...
    */
    ...
    DDS_SEQUENCE_FLAT_DATA(ResolutionSeq, Resolution);
    ...
    RTIBool Resolution_initialize_ex(
        Resolution* self,RTIBool allocatePointers,RTIBool allocateMemory);
    ...
    */
    ...
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *ResolutionPlainHelper_get_sample_seq_access_info(void);
    #endif

    DDS_SEQUENCE(ResolutionPlainHelperSeq, ResolutionPlainHelper);
    ...
    RTIBool ResolutionPlainHelper_initialize_ex(
        ResolutionPlainHelper* self,RTIBool allocatePointers,RTIBool allocateMemory);
    ...
    NDDSUSERDllExport
    void ResolutionPlainHelper_finalize(
        ResolutionPlainHelper* self);
...
namespace flat_types {
    ...
    */
    ...
    DDS_SEQUENCE_FLAT_DATA(CameraImageSeq, CameraImage);
    ...
    */
    ...
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *CameraImagePlainHelper_get_sample_seq_access_info(void);
    #endif

    DDS_SEQUENCE(CameraImagePlainHelperSeq, CameraImagePlainHelper);
    ...
    RTIBool CameraImagePlainHelper_initialize_ex(
        CameraImagePlainHelper* self,RTIBool allocatePointers,RTIBool allocateMemory);
    ...
    NDDSUSERDllExport
    void CameraImagePlainHelper_finalize(
        CameraImagePlainHelper* self);
...
namespace zero_copy_types {
    ...
    */
    ...
    NDDSUSERDllExport RTIXCdrTypePlugin *Resolution_get_type_plugin_info(void);
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *Resolution_get_sample_access_info(void);
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *Resolution_get_sample_seq_access_info(void);
    #endif

    DDS_SEQUENCE(ResolutionSeq, Resolution);
