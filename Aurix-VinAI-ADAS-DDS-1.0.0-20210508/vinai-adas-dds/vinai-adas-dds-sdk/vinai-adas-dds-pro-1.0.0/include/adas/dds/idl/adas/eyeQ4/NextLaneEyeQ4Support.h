...
namespace adas_dds {
    ...
    */
    ...
    DDS_TYPESUPPORT_CPP(
        NextLaneEyeQ4TypeSupport, 
        NextLaneEyeQ4);

    #define ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(NextLaneEyeQ4DataWriter, NextLaneEyeQ4);
    #undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
    #define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
    DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(NextLaneEyeQ4DataReader, NextLaneEyeQ4Seq, NextLaneEyeQ4);
