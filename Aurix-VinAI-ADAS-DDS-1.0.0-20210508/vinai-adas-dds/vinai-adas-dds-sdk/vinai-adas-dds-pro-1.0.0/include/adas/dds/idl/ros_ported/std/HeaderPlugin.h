...
namespace adas_dds {
    namespace std_msgs {
        ...
        * ------------------------------------------------------------------------- */
        ...
        NDDSUSERDllExport extern RTIBool
        HeaderPlugin_serialize_to_cdr_buffer(
            char * buffer,
            unsigned int * length,
            const Header *sample); 

        NDDSUSERDllExport extern RTIBool
        HeaderPlugin_serialize_to_cdr_buffer_ex(
            char *buffer,
            unsigned int *length,
            const Header *sample,
        ...
        NDDSUSERDllExport extern RTIBool
        HeaderPlugin_deserialize_from_cdr_buffer(
            Header *sample,
            const char * buffer,
            unsigned int length);    
        #ifndef NDDS_STANDALONE_TYPE
        NDDSUSERDllExport extern DDS_ReturnCode_t
        HeaderPlugin_data_to_string(
            const Header *sample,
            char *str,
        ...
        * -------------------------------------------------------------------------------------- */
        ...
        NDDSUSERDllExport extern unsigned int 
        HeaderPlugin_get_serialized_key_max_size_for_keyhash(
            PRESTypePluginEndpointData endpoint_data,
            RTIEncapsulationId encapsulation_id,
            unsigned int current_alignment);
        ...
        struct RTIXCdrInterpreterPrograms *HeaderPlugin_get_programs();
