...
namespace adas_dds {
    ...
    */
    ...
    NDDSUSERDllExport RTIXCdrSampleAccessInfo *RadarObstacle_get_sample_seq_access_info(void);
    #endif

    DDS_SEQUENCE(RadarObstacleSeq, RadarObstacle);
    ...
    RTIBool RadarObstacle_initialize_ex(
        RadarObstacle* self,RTIBool allocatePointers,RTIBool allocateMemory);
...
namespace rti { 
    namespace xcdr {
        template <>
        struct type_code<adas_dds::RadarObstacle> {
