...
/* Requires */
#include "ThrottleInfoReportPlugin.h"
...
namespace adas_dds {
    ...
    namespace dbw_mkz_msgs {
        ...
        DDS_TYPESUPPORT_CPP(ThrottleInfoReportTypeSupport, ThrottleInfoReport);
        DDS_DATAWRITER_CPP(ThrottleInfoReportDataWriter, ThrottleInfoReport);

        DDS_DATAREADER_CPP(ThrottleInfoReportDataReader, ThrottleInfoReport);
