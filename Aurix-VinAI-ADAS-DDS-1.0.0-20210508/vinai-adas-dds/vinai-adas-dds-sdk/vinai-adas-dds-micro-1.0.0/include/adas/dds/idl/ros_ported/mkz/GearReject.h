...
namespace adas_dds {
    ...
    namespace dbw_mkz_msgs {
        ...
        */
        ...
        #define T GearReject_Value
        #define TSeq GearReject_ValueSeq
        ...
        NDDSUSERDllExport extern GearReject_Value*
        GearReject_Value_create();

        NDDSUSERDllExport extern void
        GearReject_Value_delete(GearReject_Value* sample);
        ...
        NDDSUSERDllExport
        RTIBool GearReject_Value_finalize(
            GearReject_Value* self);
        ...
        */
        ...
        NDDSUSERDllExport extern void
        GearReject_delete(GearReject* sample);
