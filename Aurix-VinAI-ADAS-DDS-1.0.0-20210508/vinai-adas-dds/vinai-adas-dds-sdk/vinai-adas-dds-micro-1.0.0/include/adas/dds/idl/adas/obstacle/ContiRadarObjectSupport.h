...
namespace adas_dds {
    ...
    DDS_TYPESUPPORT_CPP(ContiRadarObjectTypeSupport, ContiRadarObject);
    DDS_DATAWRITER_CPP(ContiRadarObjectDataWriter, ContiRadarObject);

    DDS_DATAREADER_CPP(ContiRadarObjectDataReader, ContiRadarObject);
