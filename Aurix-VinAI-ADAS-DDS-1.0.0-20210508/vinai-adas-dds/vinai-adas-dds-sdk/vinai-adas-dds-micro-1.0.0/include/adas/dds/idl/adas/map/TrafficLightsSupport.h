...
namespace adas_dds {
    ...
    DDS_TYPESUPPORT_CPP(TrafficLightsTypeSupport, TrafficLights);
    DDS_DATAWRITER_CPP(TrafficLightsDataWriter, TrafficLights);

    DDS_DATAREADER_CPP(TrafficLightsDataReader, TrafficLights);
