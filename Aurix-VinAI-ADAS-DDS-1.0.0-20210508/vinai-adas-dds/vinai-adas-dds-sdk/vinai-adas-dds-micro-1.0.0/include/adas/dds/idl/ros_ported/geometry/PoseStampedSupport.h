...
namespace adas_dds {
    ...
    namespace geometry_msgs {
        ...
        DDS_TYPESUPPORT_CPP(PoseStampedTypeSupport, PoseStamped);
        DDS_DATAWRITER_CPP(PoseStampedDataWriter, PoseStamped);

        DDS_DATAREADER_CPP(PoseStampedDataReader, PoseStamped);
