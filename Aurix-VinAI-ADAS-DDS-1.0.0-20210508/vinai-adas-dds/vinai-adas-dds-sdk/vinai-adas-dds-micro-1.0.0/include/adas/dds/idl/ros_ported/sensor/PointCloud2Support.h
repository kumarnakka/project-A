...
namespace adas_dds {
    ...
    namespace sensor_msgs {
        ...
        DDS_TYPESUPPORT_CPP(PointCloud2TypeSupport, PointCloud2);
        DDS_DATAWRITER_CPP(PointCloud2DataWriter, PointCloud2);

        DDS_DATAREADER_CPP(PointCloud2DataReader, PointCloud2);
